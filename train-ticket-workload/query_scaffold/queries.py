...
class Query:
    ...
    def login(self, username="fdse_microservice", password="111111") -> bool:
        ...
        if r.status_code == 200:
            ...
            return False
        # self.session.headers.update(
        #     {"Authorization": "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJmZHNlX21pY3Jvc2VydmljZSIsInJvbGVzIjpbIlJPTEVfVVNFUiJdLCJpZCI6IjRkMmE0NmM3LTcxY2ItNGNmMS1iNWJiLWI2ODQwNmQ5ZGE2ZiIsImlhdCI6MTcyMjA0OTUxMCwiZXhwIjoxNzIyMDUzMTEwfQ.b1quZ2Ug5YmSBJQDgORWU_JNQ_dR1wQZO0XeY_8JnZE"}
        # )
    ...
    def query_advanced_ticket(self, place_pair: tuple = (), type: str = "cheapest", date: str = "", headers: dict = {}) -> List[str]:
        ...
        place_pairs = [("Shang Hai", "Su Zhou"),
                       ...
                       ("Tai Yuan", "Nan Jing"),
                       ("Nan Jing", "Tai Yuan"),
                       ("Shi Jia Zhuang", "Tai Yuan"),
                       ("Nan Jing", "Shi Jia Zhuang"),
                       ("Shang Hai", "Tai Yuan"),
                       ("Tai Yuan", "Shi Jia Zhuang"),
                       ]
